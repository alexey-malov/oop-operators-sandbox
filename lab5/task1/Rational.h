...
public:
	...
	// Возвращает результат сложения двух рациональных чисел
	CRational const operator+(CRational const& r2) const;

	// Возвращает результат сложения рационального числа с целым
	CRational const operator+(int const& number) const;

	// Возвращает результат сложения целого числа с рациональным
	friend CRational const operator+(int const& number, CRational const& r);
